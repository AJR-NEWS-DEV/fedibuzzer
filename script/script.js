...
#__fedishare__ button:hover,
#__fedishare__ button:focus-visible {
    background-color: var(--button-hover-background-color);
}

#__fedishare__ button:active {
    background-color: var(--button-hover-background-color);
}
...
(() => {
    ...
    rootEl.addEventListener('submit', (e) => {
        ...
        window.fetch(`http://localhost/fedishare/api/v1/instance?domain=${instanceDomain}`).then(async (ctx) => {
